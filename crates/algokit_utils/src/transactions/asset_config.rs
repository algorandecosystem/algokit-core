use algokit_transact::{Address, AssetConfigTransactionFields, AssetConfigTransactionBuilder, Transaction, TransactionHeader};
...
pub fn build_asset_create(params: &AssetCreateParams, header: TransactionHeader) -> Result<Transaction, String> {
