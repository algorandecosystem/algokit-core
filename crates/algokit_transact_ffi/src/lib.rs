...
#[ffi_func]
pub fn account_from_pub_key(pub_key: &[u8]) -> Result<KeyPairAccount, AlgoKitTransactError> {
    Ok(
...
#[ffi_func]
pub fn account_from_address(address: &str) -> Result<KeyPairAccount, AlgoKitTransactError> {
    address
