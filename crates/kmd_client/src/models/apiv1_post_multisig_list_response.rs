...
impl Apiv1PostMultisigListResponse {
    /// Default constructor for Apiv1PostMultisigListResponse
    pub fn new() -> Apiv1PostMultisigListResponse {
        Apiv1PostMultisigListResponse::default()
    }
}
