...
impl Apiv1PostTransactionSignResponse {
    /// Default constructor for Apiv1PostTransactionSignResponse
    pub fn new() -> Apiv1PostTransactionSignResponse {
        Apiv1PostTransactionSignResponse::default()
    }
}
