...
impl Apiv1PostMultisigExportResponse {
    /// Default constructor for Apiv1PostMultisigExportResponse
    pub fn new() -> Apiv1PostMultisigExportResponse {
        Apiv1PostMultisigExportResponse::default()
    }
}
