...
/// struct for typed errors of method [`swagger_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum SwaggerHandlerError {
    Statusdefault(),
    DefaultResponse(),
...
pub async fn swagger_handler(http_client: &dyn HttpClient) -> Result<String, Error> {
    let path = "/swagger.json".to_string();
