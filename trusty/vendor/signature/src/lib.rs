#![no_std]
// Upstream has `#![doc = include_str!("../README.md")]` here; dropped since
// we don't vendor the README (see `../rules.mk`'s provenance comment).
// Purely a doc-comment difference, no functional change.
#![doc(
