...
class _UniffiRustBuffer(ctypes.Structure):
    ...
    @staticmethod
    def alloc(size):
        return _uniffi_rust_call(_UniffiLib.ffi_algod_client_rustbuffer_alloc, size)

    @staticmethod
    def reserve(rbuf, additional):
        return _uniffi_rust_call(_UniffiLib.ffi_algod_client_rustbuffer_reserve, rbuf, additional)

    def free(self):
        return _uniffi_rust_call(_UniffiLib.ffi_algod_client_rustbuffer_free, self)
...
def _uniffi_load_indirect():
    ...
    libname = libname.format("algod_client")
...
def _uniffi_check_contract_api_version(lib):
    ...
    scaffolding_contract_version = lib.ffi_algod_client_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version:
        raise InternalError("UniFFI contract version mismatch: try cleaning and rebuilding your project")

def _uniffi_check_api_checksums(lib):
    if lib.uniffi_algod_client_checksum_method_algodclient_abort_catchup() != 33656:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_account_application_information() != 7494:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_account_asset_information() != 20467:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_account_assets_information() != 19956:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_account_information() != 19156:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_add_participation_key() != 40409:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_append_keys() != 63614:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_delete_participation_key_by_id() != 20471:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_experimental_check() != 18439:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_generate_participation_keys() != 5670:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_application_box_by_name() != 28507:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_application_boxes() != 12742:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_application_by_id() != 35816:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_asset_by_id() != 25586:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_block() != 64585:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_block_hash() != 31015:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_block_logs() != 22277:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_block_time_stamp_offset() != 48135:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_block_txids() != 21656:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_config() != 60424:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_debug_settings_prof() != 55697:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_genesis() != 48842:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta() != 19686:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta_for_transaction_group() != 1593:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_light_block_header_proof() != 33665:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_participation_key_by_id() != 8484:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_participation_keys() != 46286:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions() != 12282:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions_by_address() != 13283:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_ready() != 7044:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_state_proof() != 6502:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_status() != 22494:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_supply() != 58516:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_sync_round() != 60061:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_transaction_group_ledger_state_deltas_for_round() != 7168:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_transaction_proof() != 10069:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_get_version() != 15634:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_health_check() != 11708:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_metrics() != 43237:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_pending_transaction_information() != 18383:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_put_debug_settings_prof() != 47305:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_raw_transaction() != 58794:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_raw_transaction_async() != 10839:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_set_block_time_stamp_offset() != 23215:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_set_sync_round() != 47459:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_shutdown_node() != 35208:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_simulate_transaction() != 41522:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_start_catchup() != 6234:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_swagger_json() != 58212:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_teal_compile() != 1792:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_teal_disassemble() != 34402:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_teal_dryrun() != 9662:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_transaction_params() != 14553:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_unset_sync_round() != 38265:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_method_algodclient_wait_for_block() != 54448:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algod_client_checksum_constructor_algodclient_new() != 57443:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_algod_client_fn_clone_algodclient.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algod_client_fn_clone_algodclient.restype = ctypes.c_void_p
_UniffiLib.uniffi_algod_client_fn_free_algodclient.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algod_client_fn_free_algodclient.restype = None
_UniffiLib.uniffi_algod_client_fn_constructor_algodclient_new.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algod_client_fn_constructor_algodclient_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_algod_client_fn_method_algodclient_abort_catchup.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_abort_catchup.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_application_information.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_application_information.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_asset_information.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_asset_information.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_assets_information.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_assets_information.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_information.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_account_information.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_add_participation_key.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_add_participation_key.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_append_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_append_keys.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_delete_participation_key_by_id.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_delete_participation_key_by_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_experimental_check.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_experimental_check.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_generate_participation_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_uint64,
...
_UniffiLib.uniffi_algod_client_fn_method_algodclient_generate_participation_keys.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_box_by_name.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_box_by_name.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_boxes.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_boxes.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_by_id.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_by_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_asset_by_id.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_asset_by_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_hash.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_logs.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_logs.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_time_stamp_offset.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_time_stamp_offset.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_txids.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_txids.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_config.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_config.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_debug_settings_prof.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_debug_settings_prof.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_genesis.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_genesis.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta_for_transaction_group.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta_for_transaction_group.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_light_block_header_proof.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_light_block_header_proof.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_key_by_id.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_key_by_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_keys.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_keys.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions_by_address.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions_by_address.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ready.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ready.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_state_proof.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_state_proof.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_status.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_status.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_supply.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_supply.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_sync_round.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_sync_round.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_group_ledger_state_deltas_for_round.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_group_ledger_state_deltas_for_round.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_proof.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_proof.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_version.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_get_version.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_health_check.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_health_check.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_metrics.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_metrics.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_pending_transaction_information.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_pending_transaction_information.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_put_debug_settings_prof.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_put_debug_settings_prof.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction_async.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction_async.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_set_block_time_stamp_offset.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_set_block_time_stamp_offset.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_set_sync_round.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_set_sync_round.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_shutdown_node.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_shutdown_node.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_simulate_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_simulate_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_start_catchup.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_start_catchup.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_swagger_json.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_swagger_json.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_compile.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_compile.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_disassemble.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_disassemble.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_dryrun.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_dryrun.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_transaction_params.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_transaction_params.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_unset_sync_round.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_unset_sync_round.restype = ctypes.c_uint64
_UniffiLib.uniffi_algod_client_fn_method_algodclient_wait_for_block.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_algod_client_fn_method_algodclient_wait_for_block.restype = ctypes.c_uint64
_UniffiLib.ffi_algod_client_rustbuffer_alloc.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rustbuffer_alloc.restype = _UniffiRustBuffer
_UniffiLib.ffi_algod_client_rustbuffer_from_bytes.argtypes = (
    _UniffiForeignBytes,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rustbuffer_from_bytes.restype = _UniffiRustBuffer
_UniffiLib.ffi_algod_client_rustbuffer_free.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rustbuffer_free.restype = None
_UniffiLib.ffi_algod_client_rustbuffer_reserve.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rustbuffer_reserve.restype = _UniffiRustBuffer
_UniffiLib.ffi_algod_client_rust_future_poll_u8.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_u8.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_u8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_u8.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_u8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_u8.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_u8.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_u8.restype = ctypes.c_uint8
_UniffiLib.ffi_algod_client_rust_future_poll_i8.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_i8.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_i8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_i8.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_i8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_i8.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_i8.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_i8.restype = ctypes.c_int8
_UniffiLib.ffi_algod_client_rust_future_poll_u16.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_u16.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_u16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_u16.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_u16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_u16.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_u16.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_u16.restype = ctypes.c_uint16
_UniffiLib.ffi_algod_client_rust_future_poll_i16.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_i16.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_i16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_i16.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_i16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_i16.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_i16.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_i16.restype = ctypes.c_int16
_UniffiLib.ffi_algod_client_rust_future_poll_u32.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_u32.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_u32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_u32.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_u32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_u32.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_u32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_u32.restype = ctypes.c_uint32
_UniffiLib.ffi_algod_client_rust_future_poll_i32.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_i32.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_i32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_i32.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_i32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_i32.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_i32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_i32.restype = ctypes.c_int32
_UniffiLib.ffi_algod_client_rust_future_poll_u64.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_u64.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_u64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_u64.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_u64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_u64.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_u64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_u64.restype = ctypes.c_uint64
_UniffiLib.ffi_algod_client_rust_future_poll_i64.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_i64.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_i64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_i64.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_i64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_i64.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_i64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_i64.restype = ctypes.c_int64
_UniffiLib.ffi_algod_client_rust_future_poll_f32.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_f32.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_f32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_f32.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_f32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_f32.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_f32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_f32.restype = ctypes.c_float
_UniffiLib.ffi_algod_client_rust_future_poll_f64.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_f64.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_f64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_f64.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_f64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_f64.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_f64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_f64.restype = ctypes.c_double
_UniffiLib.ffi_algod_client_rust_future_poll_pointer.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_pointer.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_pointer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_pointer.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_pointer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_pointer.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_pointer.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_pointer.restype = ctypes.c_void_p
_UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_rust_buffer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_rust_buffer.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_rust_buffer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_rust_buffer.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer.restype = _UniffiRustBuffer
_UniffiLib.ffi_algod_client_rust_future_poll_void.argtypes = (
    ctypes.c_uint64,
    _UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_poll_void.restype = None
_UniffiLib.ffi_algod_client_rust_future_cancel_void.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_cancel_void.restype = None
_UniffiLib.ffi_algod_client_rust_future_free_void.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_algod_client_rust_future_free_void.restype = None
_UniffiLib.ffi_algod_client_rust_future_complete_void.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_algod_client_rust_future_complete_void.restype = None
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_abort_catchup.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_abort_catchup.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_application_information.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_application_information.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_asset_information.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_asset_information.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_assets_information.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_assets_information.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_information.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_account_information.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_add_participation_key.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_add_participation_key.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_append_keys.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_append_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_delete_participation_key_by_id.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_delete_participation_key_by_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_experimental_check.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_experimental_check.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_generate_participation_keys.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_generate_participation_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_box_by_name.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_box_by_name.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_boxes.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_boxes.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_by_id.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_application_by_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_asset_by_id.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_asset_by_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_hash.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_hash.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_logs.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_logs.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_time_stamp_offset.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_time_stamp_offset.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_txids.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_block_txids.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_config.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_config.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_debug_settings_prof.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_debug_settings_prof.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_genesis.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_genesis.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta_for_transaction_group.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ledger_state_delta_for_transaction_group.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_light_block_header_proof.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_light_block_header_proof.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_participation_key_by_id.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_participation_key_by_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_participation_keys.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_participation_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions_by_address.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_pending_transactions_by_address.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ready.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_ready.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_state_proof.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_state_proof.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_status.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_status.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_supply.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_supply.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_sync_round.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_sync_round.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_transaction_group_ledger_state_deltas_for_round.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_transaction_group_ledger_state_deltas_for_round.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_transaction_proof.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_transaction_proof.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_version.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_get_version.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_health_check.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_health_check.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_metrics.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_metrics.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_pending_transaction_information.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_pending_transaction_information.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_put_debug_settings_prof.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_put_debug_settings_prof.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_raw_transaction.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_raw_transaction.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_raw_transaction_async.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_raw_transaction_async.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_set_block_time_stamp_offset.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_set_block_time_stamp_offset.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_set_sync_round.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_set_sync_round.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_shutdown_node.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_shutdown_node.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_simulate_transaction.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_simulate_transaction.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_start_catchup.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_start_catchup.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_swagger_json.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_swagger_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_compile.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_compile.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_disassemble.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_disassemble.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_dryrun.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_teal_dryrun.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_transaction_params.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_transaction_params.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_unset_sync_round.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_unset_sync_round.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_wait_for_block.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_method_algodclient_wait_for_block.restype = ctypes.c_uint16
_UniffiLib.uniffi_algod_client_checksum_constructor_algodclient_new.argtypes = (
)
_UniffiLib.uniffi_algod_client_checksum_constructor_algodclient_new.restype = ctypes.c_uint16
_UniffiLib.ffi_algod_client_uniffi_contract_version.argtypes = (
)
_UniffiLib.ffi_algod_client_uniffi_contract_version.restype = ctypes.c_uint32
...
class AccountStateDelta:
    ...
    address: "str"
    delta: "typing.List[EvalDeltaKeyValue]"
    def __init__(self, *, address: "str", delta: "typing.List[EvalDeltaKeyValue]"):
        self.address = address
        self.delta = delta
...
class _UniffiConverterTypeAccountStateDelta(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return AccountStateDelta(
            address=_UniffiConverterString.read(buf),
            delta=_UniffiConverterSequenceTypeEvalDeltaKeyValue.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.address)
        _UniffiConverterSequenceTypeEvalDeltaKeyValue.check_lower(value.delta)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.address, buf)
        _UniffiConverterSequenceTypeEvalDeltaKeyValue.write(value.delta, buf)
...
class ApplicationLocalState:
    ...
    key_value: "typing.Optional[typing.List[TealKeyValue]]"
    def __init__(self, *, id: "int", schema: "ApplicationStateSchema", key_value: "typing.Optional[typing.List[TealKeyValue]]"):
        self.id = id
        self.schema = schema
...
class _UniffiConverterTypeApplicationLocalState(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ApplicationLocalState(
            ...
            key_value=_UniffiConverterOptionalSequenceTypeTealKeyValue.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalSequenceTypeTealKeyValue.check_lower(value.key_value)

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt64.write(value.id, buf)
        _UniffiConverterTypeApplicationStateSchema.write(value.schema, buf)
        _UniffiConverterOptionalSequenceTypeTealKeyValue.write(value.key_value, buf)
...
class ApplicationParams:
    ...
    global_state: "typing.Optional[typing.List[TealKeyValue]]"
    version: "typing.Optional[int]"
    """
    [v] the number of updates to the application programs
    """

    def __init__(self, *, creator: "str", approval_program: "bytes", clear_state_program: "bytes", extra_program_pages: "typing.Optional[int]", local_state_schema: "typing.Optional[ApplicationStateSchema]", global_state_schema: "typing.Optional[ApplicationStateSchema]", global_state: "typing.Optional[typing.List[TealKeyValue]]", version: "typing.Optional[int]"):
...
class _UniffiConverterTypeApplicationParams(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ApplicationParams(
            ...
            global_state=_UniffiConverterOptionalSequenceTypeTealKeyValue.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalSequenceTypeTealKeyValue.check_lower(value.global_state)
    ...
    def write(value, buf):
        ...
        _UniffiConverterOptionalSequenceTypeTealKeyValue.write(value.global_state, buf)
...
class DryrunTxnResult:
    ...
    global_delta: "typing.Optional[typing.List[EvalDeltaKeyValue]]"
    ...
    def __init__(self, *, disassembly: "typing.List[str]", logic_sig_disassembly: "typing.Optional[typing.List[str]]", logic_sig_trace: "typing.Optional[typing.List[DryrunState]]", logic_sig_messages: "typing.Optional[typing.List[str]]", app_call_trace: "typing.Optional[typing.List[DryrunState]]", app_call_messages: "typing.Optional[typing.List[str]]", global_delta: "typing.Optional[typing.List[EvalDeltaKeyValue]]", local_deltas: "typing.Optional[typing.List[AccountStateDelta]]", logs: "typing.Optional[typing.List[bytes]]", budget_added: "typing.Optional[int]", budget_consumed: "typing.Optional[int]"):
...
class _UniffiConverterTypeDryrunTxnResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return DryrunTxnResult(
            ...
            global_delta=_UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.check_lower(value.global_delta)
    ...
    def write(value, buf):
        ...
        _UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.write(value.global_delta, buf)
...
class ErrorResponse:
    ...
    message: "str"
    def __init__(self, *, data: "typing.Optional[str]", message: "str"):
        self.data = data
...
class GenesisAllocation:
    ...
    comment: "str"
    state: "str"
    def __init__(self, *, addr: "str", comment: "str", state: "str"):
        self.addr = addr
        self.comment = comment
        self.state = state
...
class GetBlock:
    ...
    def __init__(self, *, block: "str", cert: "typing.Optional[str]"):
        self.block = block
        self.cert = cert
...
class _UniffiConverterTypeGetBlock(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return GetBlock(
            block=_UniffiConverterString.read(buf),
            cert=_UniffiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.block)
        _UniffiConverterOptionalString.check_lower(value.cert)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.block, buf)
        _UniffiConverterOptionalString.write(value.cert, buf)
...
class PendingTransactionResponse:
    ...
    global_state_delta: "typing.Optional[typing.List[EvalDeltaKeyValue]]"
    logs: "typing.Optional[typing.List[bytes]]"
    """
...
class _UniffiConverterTypePendingTransactionResponse(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return PendingTransactionResponse(
            ...
            global_state_delta=_UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.read(buf),
            logs=_UniffiConverterOptionalSequenceBytes.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.check_lower(value.global_state_delta)
        _UniffiConverterOptionalSequenceBytes.check_lower(value.logs)
    ...
    def write(value, buf):
        ...
        _UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue.write(value.global_state_delta, buf)
        _UniffiConverterOptionalSequenceBytes.write(value.logs, buf)
...
class TealCompile:
    ...
    sourcemap: "typing.Optional[str]"
    """
    JSON of the source map
    """

    def __init__(self, *, hash: "str", result: "bytes", sourcemap: "typing.Optional[str]"):
        self.hash = hash
        self.result = result
...
class _UniffiConverterTypeTealCompile(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return TealCompile(
            ...
            sourcemap=_UniffiConverterOptionalString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalString.check_lower(value.sourcemap)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.hash, buf)
        _UniffiConverterBytes.write(value.result, buf)
        _UniffiConverterOptionalString.write(value.sourcemap, buf)
...
class _UniffiConverterOptionalSequenceTypeEvalDeltaKeyValue(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterSequenceTypeEvalDeltaKeyValue.check_lower(value)
...
class _UniffiConverterOptionalSequenceTypeTealKeyValue(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterSequenceTypeTealKeyValue.check_lower(value)
...
class AlgodClient():
    ...
    def __init__(self, http_client: "HttpClient"):
        ...
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_algod_client_fn_constructor_algodclient_new,
    ...
    def __del__(self):
        ...
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_algod_client_fn_free_algodclient, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_algod_client_fn_clone_algodclient, self._pointer)
    ...
    async def abort_catchup(self, catchpoint: "str") -> "AbortCatchup":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_abort_catchup(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(catchpoint)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_free_rust_buffer,
            # lift function
...
_UniffiConverterTypeError,
    ...
    async def account_application_information(self, address: "str",application_id: "int",format: "typing.Optional[Format]") -> "AccountApplicationInformation":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_account_application_information(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def account_asset_information(self, address: "str",asset_id: "int",format: "typing.Optional[Format]") -> "AccountAssetInformation":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_account_asset_information(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(address),
...
_UniffiConverterTypeError,
    ...
    async def account_assets_information(self, address: "str",limit: "typing.Optional[int]",next: "typing.Optional[str]") -> "AccountAssetsInformation":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_account_assets_information(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(address),
...
_UniffiConverterTypeError,
    ...
    async def account_information(self, address: "str",exclude: "typing.Optional[Exclude]",format: "typing.Optional[Format]") -> "Account":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_account_information(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(address),
...
_UniffiConverterTypeError,
    ...
    async def add_participation_key(self, request: "bytes") -> "AddParticipationKey":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_add_participation_key(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def append_keys(self, request: "bytes",participation_id: "str") -> "ParticipationKey":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_append_keys(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(request),
...
_UniffiConverterTypeError,
    ...
    async def delete_participation_key_by_id(self, participation_id: "str") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_delete_participation_key_by_id(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(participation_id)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
            _UniffiLib.ffi_algod_client_rust_future_free_void,
            # lift function
            lambda val: None,
...
_UniffiConverterTypeError,
    ...
    async def experimental_check(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_experimental_check(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
...
_UniffiConverterTypeError,
    ...
    async def generate_participation_keys(self, address: "str",dilution: "typing.Optional[int]",first: "int",last: "int") -> "str":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_generate_participation_keys(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(address),
...
_UniffiConverterTypeError,
    ...
    async def get_application_box_by_name(self, application_id: "int",name: "str") -> "Box":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_box_by_name(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(application_id),
...
_UniffiConverterTypeError,
    ...
    async def get_application_boxes(self, application_id: "int",max: "typing.Optional[int]") -> "GetApplicationBoxes":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_boxes(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(application_id),
...
_UniffiConverterTypeError,
    ...
    async def get_application_by_id(self, application_id: "int") -> "Application":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_application_by_id(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(application_id)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_asset_by_id(self, asset_id: "int") -> "Asset":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_asset_by_id(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(asset_id)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_block(self, round: "int",header_only: "typing.Optional[bool]",format: "typing.Optional[Format]") -> "GetBlock":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def get_block_hash(self, round: "int") -> "GetBlockHash":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_hash(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_block_logs(self, round: "int") -> "GetBlockLogs":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_logs(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_block_time_stamp_offset(self, ) -> "GetBlockTimeStampOffset":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_time_stamp_offset(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_block_txids(self, round: "int") -> "GetBlockTxids":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_block_txids(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_config(self, ) -> "str":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_config(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_debug_settings_prof(self, ) -> "DebugSettingsProf":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_debug_settings_prof(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_genesis(self, ) -> "Genesis":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_genesis(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_ledger_state_delta(self, round: "int",format: "typing.Optional[Format]") -> "LedgerStateDelta":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round),
        _UniffiConverterOptionalTypeFormat.lower(format)
            ),
...
_UniffiConverterTypeError,
    ...
    async def get_ledger_state_delta_for_transaction_group(self, id: "str",format: "typing.Optional[Format]") -> "LedgerStateDelta":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ledger_state_delta_for_transaction_group(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def get_light_block_header_proof(self, round: "int") -> "LightBlockHeaderProof":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_light_block_header_proof(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_participation_key_by_id(self, participation_id: "str") -> "ParticipationKey":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_key_by_id(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(participation_id)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_participation_keys(self, ) -> "typing.List[ParticipationKey]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_participation_keys(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_pending_transactions(self, max: "typing.Optional[int]",format: "typing.Optional[Format]") -> "GetPendingTransactions":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions(
                self._uniffi_clone_pointer(), 
        _UniffiConverterOptionalUInt64.lower(max),
        _UniffiConverterOptionalTypeFormat.lower(format)
            ),
...
_UniffiConverterTypeError,
    ...
    async def get_pending_transactions_by_address(self, address: "str",max: "typing.Optional[int]",format: "typing.Optional[Format]") -> "GetPendingTransactionsByAddress":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_pending_transactions_by_address(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(address),
        _UniffiConverterOptionalUInt64.lower(max),
        _UniffiConverterOptionalTypeFormat.lower(format)
...
_UniffiConverterTypeError,
    ...
    async def get_ready(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_ready(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
...
_UniffiConverterTypeError,
    ...
    async def get_state_proof(self, round: "int") -> "StateProof":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_state_proof(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_status(self, ) -> "GetStatus":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_status(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_supply(self, ) -> "GetSupply":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_supply(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_sync_round(self, ) -> "GetSyncRound":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_sync_round(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def get_transaction_group_ledger_state_deltas_for_round(self, round: "int",format: "typing.Optional[Format]") -> "GetTransactionGroupLedgerStateDeltasForRound":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_group_ledger_state_deltas_for_round(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round),
        _UniffiConverterOptionalTypeFormat.lower(format)
            ),
...
_UniffiConverterTypeError,
    ...
    async def get_transaction_proof(self, round: "int",txid: "str",hashtype: "typing.Optional[Hashtype]",format: "typing.Optional[Format]") -> "TransactionProof":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_transaction_proof(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round),
...
_UniffiConverterTypeError,
    ...
    async def get_version(self, ) -> "Version":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_get_version(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def health_check(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_health_check(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
...
_UniffiConverterTypeError,
    ...
    async def metrics(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_metrics(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
...
_UniffiConverterTypeError,
    ...
    async def pending_transaction_information(self, txid: "str",format: "typing.Optional[Format]") -> "PendingTransactionResponse":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_pending_transaction_information(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(txid),
        _UniffiConverterOptionalTypeFormat.lower(format)
            ),
...
_UniffiConverterTypeError,
    ...
    async def put_debug_settings_prof(self, ) -> "DebugSettingsProf":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_put_debug_settings_prof(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def raw_transaction(self, request: "bytes") -> "RawTransaction":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(request)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def raw_transaction_async(self, request: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_raw_transaction_async(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(request)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
...
_UniffiConverterTypeError,
    ...
    async def set_block_time_stamp_offset(self, offset: "int") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_set_block_time_stamp_offset(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def set_sync_round(self, round: "int") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_set_sync_round(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
...
_UniffiConverterTypeError,
    ...
    async def shutdown_node(self, timeout: "typing.Optional[int]") -> "str":
        """
        Special management endpoint to shutdown the node. Optionally provide a timeout parameter to indicate that the node should begin shutting down after a number of seconds.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_shutdown_node(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def simulate_transaction(self, request: "SimulateRequest",format: "typing.Optional[Format]") -> "SimulateTransaction":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_simulate_transaction(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def start_catchup(self, catchpoint: "str",min: "typing.Optional[int]") -> "StartCatchup":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_start_catchup(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(catchpoint),
...
_UniffiConverterTypeError,
    ...
    async def swagger_json(self, ) -> "str":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_swagger_json(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def teal_compile(self, request: "bytes",sourcemap: "typing.Optional[bool]") -> "TealCompile":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_compile(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(request),
...
_UniffiConverterTypeError,
    ...
    async def teal_disassemble(self, request: "str") -> "TealDisassemble":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_disassemble(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def teal_dryrun(self, request: "typing.Optional[DryrunRequest]") -> "TealDryrun":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_teal_dryrun(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def transaction_params(self, ) -> "TransactionParams":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_transaction_params(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_algod_client_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeError,
    ...
    async def unset_sync_round(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_unset_sync_round(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_void,
            _UniffiLib.ffi_algod_client_rust_future_complete_void,
...
_UniffiConverterTypeError,
    ...
    async def wait_for_block(self, round: "int") -> "WaitForBlock":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algod_client_fn_method_algodclient_wait_for_block(
                self._uniffi_clone_pointer(), 
        _UniffiConverterUInt64.lower(round)
            ),
            _UniffiLib.ffi_algod_client_rust_future_poll_rust_buffer,
