...
class _UniffiConverterTypeFalconSignatureStruct(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return FalconSignatureStruct(
            signature=_UniffiConverterBytes.read(buf),
            vector_commitment_index=_UniffiConverterUInt64.read(buf),
            proof=_UniffiConverterTypeMerkleArrayProof.read(buf),
            verifying_key=_UniffiConverterTypeFalconVerifier.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterBytes.check_lower(value.signature)
        _UniffiConverterUInt64.check_lower(value.vector_commitment_index)
        _UniffiConverterTypeMerkleArrayProof.check_lower(value.proof)
        _UniffiConverterTypeFalconVerifier.check_lower(value.verifying_key)

    @staticmethod
    def write(value, buf):
        _UniffiConverterBytes.write(value.signature, buf)
        _UniffiConverterUInt64.write(value.vector_commitment_index, buf)
        _UniffiConverterTypeMerkleArrayProof.write(value.proof, buf)
        _UniffiConverterTypeFalconVerifier.write(value.verifying_key, buf)
...
class _UniffiConverterTypeFalconVerifier(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class _UniffiConverterTypeHashFactory(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return HashFactory(
            hash_type=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterUInt64.check_lower(value.hash_type)

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt64.write(value.hash_type, buf)
...
class _UniffiConverterTypeHeartbeatProof(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return HeartbeatProof(
            sig=_UniffiConverterBytes.read(buf),
            pk=_UniffiConverterBytes.read(buf),
            pk2=_UniffiConverterBytes.read(buf),
            pk1_sig=_UniffiConverterBytes.read(buf),
            pk2_sig=_UniffiConverterBytes.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterBytes.check_lower(value.sig)
        _UniffiConverterBytes.check_lower(value.pk)
        _UniffiConverterBytes.check_lower(value.pk2)
        _UniffiConverterBytes.check_lower(value.pk1_sig)
        _UniffiConverterBytes.check_lower(value.pk2_sig)

    @staticmethod
    def write(value, buf):
        _UniffiConverterBytes.write(value.sig, buf)
        _UniffiConverterBytes.write(value.pk, buf)
        _UniffiConverterBytes.write(value.pk2, buf)
        _UniffiConverterBytes.write(value.pk1_sig, buf)
        _UniffiConverterBytes.write(value.pk2_sig, buf)
...
class _UniffiConverterTypeHeartbeatTransactionFields(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return HeartbeatTransactionFields(
            address=_UniffiConverterString.read(buf),
            proof=_UniffiConverterTypeHeartbeatProof.read(buf),
            seed=_UniffiConverterBytes.read(buf),
            vote_id=_UniffiConverterBytes.read(buf),
            key_dilution=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.address)
        _UniffiConverterTypeHeartbeatProof.check_lower(value.proof)
        _UniffiConverterBytes.check_lower(value.seed)
        _UniffiConverterBytes.check_lower(value.vote_id)
        _UniffiConverterUInt64.check_lower(value.key_dilution)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.address, buf)
        _UniffiConverterTypeHeartbeatProof.write(value.proof, buf)
        _UniffiConverterBytes.write(value.seed, buf)
        _UniffiConverterBytes.write(value.vote_id, buf)
        _UniffiConverterUInt64.write(value.key_dilution, buf)
...
class _UniffiConverterTypeMerkleArrayProof(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return MerkleArrayProof(
            path=_UniffiConverterSequenceBytes.read(buf),
            hash_factory=_UniffiConverterTypeHashFactory.read(buf),
            tree_depth=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterSequenceBytes.check_lower(value.path)
        _UniffiConverterTypeHashFactory.check_lower(value.hash_factory)
        _UniffiConverterUInt64.check_lower(value.tree_depth)

    @staticmethod
    def write(value, buf):
        _UniffiConverterSequenceBytes.write(value.path, buf)
        _UniffiConverterTypeHashFactory.write(value.hash_factory, buf)
        _UniffiConverterUInt64.write(value.tree_depth, buf)
...
class _UniffiConverterTypeMerkleSignatureVerifier(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return MerkleSignatureVerifier(
            commitment=_UniffiConverterBytes.read(buf),
            key_lifetime=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterBytes.check_lower(value.commitment)
        _UniffiConverterUInt64.check_lower(value.key_lifetime)

    @staticmethod
    def write(value, buf):
        _UniffiConverterBytes.write(value.commitment, buf)
        _UniffiConverterUInt64.write(value.key_lifetime, buf)
...
class _UniffiConverterTypeParticipant(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return Participant(
            verifier=_UniffiConverterTypeMerkleSignatureVerifier.read(buf),
            weight=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterTypeMerkleSignatureVerifier.check_lower(value.verifier)
        _UniffiConverterUInt64.check_lower(value.weight)

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypeMerkleSignatureVerifier.write(value.verifier, buf)
...
class _UniffiConverterTypeReveal(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return Reveal(
            position=_UniffiConverterUInt64.read(buf),
            sigslot=_UniffiConverterTypeSigslotCommit.read(buf),
            participant=_UniffiConverterTypeParticipant.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterUInt64.check_lower(value.position)
        _UniffiConverterTypeSigslotCommit.check_lower(value.sigslot)
        _UniffiConverterTypeParticipant.check_lower(value.participant)

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt64.write(value.position, buf)
        _UniffiConverterTypeSigslotCommit.write(value.sigslot, buf)
        _UniffiConverterTypeParticipant.write(value.participant, buf)
...
class _UniffiConverterTypeSigslotCommit(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return SigslotCommit(
            sig=_UniffiConverterTypeFalconSignatureStruct.read(buf),
            lower_sig_weight=_UniffiConverterUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterTypeFalconSignatureStruct.check_lower(value.sig)
        _UniffiConverterUInt64.check_lower(value.lower_sig_weight)

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypeFalconSignatureStruct.write(value.sig, buf)
        _UniffiConverterUInt64.write(value.lower_sig_weight, buf)
...
class StateProof:
    ...
    reveals: "typing.List[Reveal]"
    positions_to_reveal: "typing.List[int]"
...
class _UniffiConverterTypeStateProof(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return StateProof(
            sig_commit=_UniffiConverterBytes.read(buf),
            signed_weight=_UniffiConverterUInt64.read(buf),
            sig_proofs=_UniffiConverterTypeMerkleArrayProof.read(buf),
            part_proofs=_UniffiConverterTypeMerkleArrayProof.read(buf),
            merkle_signature_salt_version=_UniffiConverterUInt64.read(buf),
            reveals=_UniffiConverterSequenceTypeReveal.read(buf),
            positions_to_reveal=_UniffiConverterSequenceUInt64.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterBytes.check_lower(value.sig_commit)
        _UniffiConverterUInt64.check_lower(value.signed_weight)
        _UniffiConverterTypeMerkleArrayProof.check_lower(value.sig_proofs)
        _UniffiConverterTypeMerkleArrayProof.check_lower(value.part_proofs)
        _UniffiConverterUInt64.check_lower(value.merkle_signature_salt_version)
        _UniffiConverterSequenceTypeReveal.check_lower(value.reveals)
        _UniffiConverterSequenceUInt64.check_lower(value.positions_to_reveal)

    @staticmethod
    def write(value, buf):
        _UniffiConverterBytes.write(value.sig_commit, buf)
        _UniffiConverterUInt64.write(value.signed_weight, buf)
        _UniffiConverterTypeMerkleArrayProof.write(value.sig_proofs, buf)
        _UniffiConverterTypeMerkleArrayProof.write(value.part_proofs, buf)
        _UniffiConverterUInt64.write(value.merkle_signature_salt_version, buf)
        _UniffiConverterSequenceTypeReveal.write(value.reveals, buf)
        _UniffiConverterSequenceUInt64.write(value.positions_to_reveal, buf)
...
class StateProofTransactionFields:
    state_proof_type: "typing.Optional[int]"
    state_proof: "typing.Optional[StateProof]"
    message: "typing.Optional[StateProofMessage]"
...
class _UniffiConverterTypeStateProofTransactionFields(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StateProofTransactionFields(
            state_proof_type=_UniffiConverterOptionalUInt64.read(buf),
            state_proof=_UniffiConverterOptionalTypeStateProof.read(buf),
            message=_UniffiConverterOptionalTypeStateProofMessage.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterOptionalUInt64.check_lower(value.state_proof_type)
        _UniffiConverterOptionalTypeStateProof.check_lower(value.state_proof)
        _UniffiConverterOptionalTypeStateProofMessage.check_lower(value.message)

    @staticmethod
    def write(value, buf):
        _UniffiConverterOptionalUInt64.write(value.state_proof_type, buf)
        _UniffiConverterOptionalTypeStateProof.write(value.state_proof, buf)
        _UniffiConverterOptionalTypeStateProofMessage.write(value.message, buf)
...
class _UniffiConverterTypeStateSchema(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return StateSchema(
            num_uints=_UniffiConverterUInt32.read(buf),
            num_byte_slices=_UniffiConverterUInt32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterUInt32.check_lower(value.num_uints)
        _UniffiConverterUInt32.check_lower(value.num_byte_slices)

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt32.write(value.num_uints, buf)
        _UniffiConverterUInt32.write(value.num_byte_slices, buf)
...
class Transaction:
    ...
    heartbeat: "typing.Optional[HeartbeatTransactionFields]"
    state_proof: "typing.Optional[StateProofTransactionFields]"
...
class _UniffiConverterTypeTransaction(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return Transaction(
            ...
            heartbeat=_UniffiConverterOptionalTypeHeartbeatTransactionFields.read(buf),
            state_proof=_UniffiConverterOptionalTypeStateProofTransactionFields.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalTypeHeartbeatTransactionFields.check_lower(value.heartbeat)
        _UniffiConverterOptionalTypeStateProofTransactionFields.check_lower(value.state_proof)
    ...
    def write(value, buf):
        ...
        _UniffiConverterOptionalTypeHeartbeatTransactionFields.write(value.heartbeat, buf)
        _UniffiConverterOptionalTypeStateProofTransactionFields.write(value.state_proof, buf)
...
class _UniffiConverterOptionalTypeHeartbeatTransactionFields(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeHeartbeatTransactionFields.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeHeartbeatTransactionFields.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeHeartbeatTransactionFields.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
...
class _UniffiConverterOptionalTypeStateProof(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeStateProof.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeStateProof.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeStateProof.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")



class _UniffiConverterOptionalTypeStateProofMessage(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeStateProofMessage.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeStateProofMessage.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeStateProofMessage.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")



class _UniffiConverterOptionalTypeStateProofTransactionFields(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeStateProofTransactionFields.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeStateProofTransactionFields.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeStateProofTransactionFields.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
...
class _UniffiConverterSequenceTypeReveal(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiConverterTypeReveal.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiConverterTypeReveal.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiConverterTypeReveal.read(buf) for i in range(count)
        ]
...
def address_from_public_key(public_key: "bytes") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_public_key,
...
def calculate_fee(transaction: "Transaction",fee_params: "FeeParams") -> "int":
    ...
    return _UniffiConverterUInt64.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_calculate_fee,
        _UniffiConverterTypeTransaction.lower(transaction),
        _UniffiConverterTypeFeeParams.lower(fee_params)))
...
def decode_signed_transaction(encoded_signed_transaction: "bytes") -> "SignedTransaction":
    ...
    * `encoded_signed_transaction` - The MsgPack encoded signed transaction bytes
    ...
    _UniffiConverterBytes.check_lower(encoded_signed_transaction)
    ...
    return _UniffiConverterTypeSignedTransaction.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_decode_signed_transaction,
        _UniffiConverterBytes.lower(encoded_signed_transaction)))
...
def decode_signed_transactions(encoded_signed_transactions: "typing.List[bytes]") -> "typing.List[SignedTransaction]":
    ...
    * `encoded_signed_transactions` - A collection of MsgPack encoded bytes, each representing a signed transaction.
    ...
    _UniffiConverterSequenceBytes.check_lower(encoded_signed_transactions)
    ...
    return _UniffiConverterSequenceTypeSignedTransaction.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_decode_signed_transactions,
        _UniffiConverterSequenceBytes.lower(encoded_signed_transactions)))
...
def encode_signed_transaction(signed_transaction: "SignedTransaction") -> "bytes":
    ...
    * `signed_transaction` - The signed transaction to encode
    ...
    _UniffiConverterTypeSignedTransaction.check_lower(signed_transaction)
    ...
    return _UniffiConverterBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_encode_signed_transaction,
        _UniffiConverterTypeSignedTransaction.lower(signed_transaction)))
...
def encode_signed_transactions(signed_transactions: "typing.List[SignedTransaction]") -> "typing.List[bytes]":
    ...
    * `signed_transactions` - A collection of signed transactions to encode
    ...
    _UniffiConverterSequenceTypeSignedTransaction.check_lower(signed_transactions)
    ...
    return _UniffiConverterSequenceBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_encode_signed_transactions,
        _UniffiConverterSequenceTypeSignedTransaction.lower(signed_transactions)))
...
def get_encoded_transaction_type(encoded_transaction: "bytes") -> "TransactionType":
    ...
    _UniffiConverterBytes.check_lower(encoded_transaction)
    ...
    return _UniffiConverterTypeTransactionType.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_get_encoded_transaction_type,
        _UniffiConverterBytes.lower(encoded_transaction)))
...
def public_key_from_address(address: "str") -> "bytes":
    ...
    return _UniffiConverterBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_public_key_from_address,
