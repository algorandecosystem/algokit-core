 ...
 * This smoke test is generated by ts_oas_generator.
 * Location: tests/generated/smoke.generated.spec.ts
 */
...
describe("Msgpack binary response", () => {
  it("decodes msgpack into structured data", async () => {
    ...
    const msg = { ok: 1n, small: 2 };
    const bytes: Uint8Array = encode(msg);
    global.fetch = async () => ({
      ok: true,
    ...
    const client = new Client({ BASE });
    const res = await client.request.request<{ ok: bigint | number; small: number }>({ method: "GET", url: "/foo", expectBinary: true });
