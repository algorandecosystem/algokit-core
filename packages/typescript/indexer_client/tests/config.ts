...
/**
 * Creates a small dummy asset on localnet and waits for confirmation.
 * Returns the created asset id. Uses first wallet account (from KMD) or provided mnemonic via env.
 */
...
/**
 * Creates a minimal dummy application with no-op approval & clear programs.
