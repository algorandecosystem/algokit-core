...
internal interface IntegrityCheckingUniffiLib : Library {
  ...
  fun uniffi_algokit_transact_ffi_checksum_func_ed25519_sign_transaction(): Short
  ...
  fun uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_address(): Short

  fun uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_bytes_to_sign(): Short

  fun uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_bytes_to_sign_for_multisig(): Short
  ...
  fun uniffi_algokit_transact_ffi_checksum_func_validate_logic_signature(): Short
...
internal interface UniffiLib : Library {
  ...
  fun uniffi_algokit_transact_ffi_fn_func_ed25519_sign_transaction(
    `secretKey`: RustBuffer.ByValue,
    `txn`: RustBuffer.ByValue,
    uniffi_out_err: UniffiRustCallStatus,
  ): RustBuffer.ByValue
  ...
  fun uniffi_algokit_transact_ffi_fn_func_get_logic_signature_address(
    `logic`: RustBuffer.ByValue,
    uniffi_out_err: UniffiRustCallStatus,
  ): RustBuffer.ByValue

  fun uniffi_algokit_transact_ffi_fn_func_get_logic_signature_bytes_to_sign(
    `logic`: RustBuffer.ByValue,
    uniffi_out_err: UniffiRustCallStatus,
  ): RustBuffer.ByValue

  fun uniffi_algokit_transact_ffi_fn_func_get_logic_signature_bytes_to_sign_for_multisig(
    `logic`: RustBuffer.ByValue,
    `multisignature`: RustBuffer.ByValue,
    uniffi_out_err: UniffiRustCallStatus,
  ): RustBuffer.ByValue
  ...
  fun uniffi_algokit_transact_ffi_fn_func_validate_logic_signature(
    `logicSignature`: RustBuffer.ByValue,
    uniffi_out_err: UniffiRustCallStatus,
  ): Unit
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
  ...
  if (lib.uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_address() != 43834.toShort()) {
    throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
  }
  if (lib.uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_bytes_to_sign() != 49447.toShort()) {
    throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
  }
  if (lib.uniffi_algokit_transact_ffi_checksum_func_get_logic_signature_bytes_to_sign_for_multisig() != 9568.toShort()) {
    throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
  }
  ...
  if (lib.uniffi_algokit_transact_ffi_checksum_func_validate_logic_signature() != 25417.toShort()) {
    throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
  }
}
...
data class AppCallTransactionFields(
   ...
   */
  var `access`: List<ResourceRef>? = null,
) {
  companion object
}
...
public object FfiConverterTypeAppCallTransactionFields : FfiConverterRustBuffer<AppCallTransactionFields> {
  override fun read(buf: ByteBuffer): AppCallTransactionFields =
    AppCallTransactionFields(
      ...
      FfiConverterOptionalSequenceTypeResourceRef.read(buf),
    )
  ...
  override fun allocationSize(value: AppCallTransactionFields) =
    (
      FfiConverterULong.allocationSize(value.`appId`) +
        ...
        FfiConverterOptionalSequenceTypeResourceRef.allocationSize(value.`access`)
    )
  ...
  override fun write(
    ...
    FfiConverterOptionalSequenceTypeResourceRef.write(value.`access`, buf)
  }
}
...
public object FfiConverterTypeHeartbeatTransactionFields : FfiConverterRustBuffer<HeartbeatTransactionFields> {
  ...
  override fun write(
    value: HeartbeatTransactionFields,
    buf: ByteBuffer,
  ) {
 ...
 * @suppress
 */
public object FfiConverterTypeHoldingRef : FfiConverterRustBuffer<HoldingRef> {
  override fun read(buf: ByteBuffer): HoldingRef =
    HoldingRef(
      FfiConverterULong.read(buf),
      FfiConverterULong.read(buf),
    )

  override fun allocationSize(value: HoldingRef) =
    (
      FfiConverterULong.allocationSize(value.`address`) +
        FfiConverterULong.allocationSize(value.`asset`)
    )
  ...
  override fun write(
    ...
    FfiConverterULong.write(value.`address`, buf)
    FfiConverterULong.write(value.`asset`, buf)
  }
}
 ...
 * @suppress
 */
public object FfiConverterTypeLocalsRef : FfiConverterRustBuffer<LocalsRef> {
  override fun read(buf: ByteBuffer): LocalsRef =
    LocalsRef(
      FfiConverterULong.read(buf),
      FfiConverterULong.read(buf),
    )

  override fun allocationSize(value: LocalsRef) =
    (
      FfiConverterULong.allocationSize(value.`address`) +
        FfiConverterULong.allocationSize(value.`app`)
    )
  ...
  override fun write(
    ...
    FfiConverterULong.write(value.`address`, buf)
    FfiConverterULong.write(value.`app`, buf)
  }
}
...
data class LogicSignature(
   ...
   */
  var `logicMultisignature`: MultisigSignature? = null,
  /**
 ...
 * @suppress
 */
public object FfiConverterTypeLogicSignature : FfiConverterRustBuffer<LogicSignature> {
  override fun read(buf: ByteBuffer): LogicSignature =
    LogicSignature(
      FfiConverterByteArray.read(buf),
      FfiConverterOptionalByteArray.read(buf),
  ...
  override fun allocationSize(value: LogicSignature) =
    (
      FfiConverterByteArray.allocationSize(value.`logic`) +
        ...
        FfiConverterOptionalTypeMultisigSignature.allocationSize(value.`logicMultisignature`) +
        FfiConverterOptionalSequenceByteArray.allocationSize(value.`args`)
    )

  override fun write(
    value: LogicSignature,
    buf: ByteBuffer,
  ) {
    FfiConverterByteArray.write(value.`logic`, buf)
    ...
    FfiConverterOptionalTypeMultisigSignature.write(value.`logicMultisignature`, buf)
    FfiConverterOptionalSequenceByteArray.write(value.`args`, buf)
  }
}
 ...
 * @suppress
 */
public object FfiConverterTypeResourceRef : FfiConverterRustBuffer<ResourceRef> {
  override fun read(buf: ByteBuffer): ResourceRef =
    ResourceRef(
      FfiConverterOptionalString.read(buf),
      FfiConverterOptionalULong.read(buf),
      FfiConverterOptionalULong.read(buf),
      FfiConverterOptionalTypeHoldingRef.read(buf),
      FfiConverterOptionalTypeLocalsRef.read(buf),
      FfiConverterOptionalTypeBoxReference.read(buf),
    )

  override fun allocationSize(value: ResourceRef) =
    (
      FfiConverterOptionalString.allocationSize(value.`address`) +
        FfiConverterOptionalULong.allocationSize(value.`asset`) +
        FfiConverterOptionalULong.allocationSize(value.`app`) +
        FfiConverterOptionalTypeHoldingRef.allocationSize(value.`holding`) +
        FfiConverterOptionalTypeLocalsRef.allocationSize(value.`locals`) +
        FfiConverterOptionalTypeBoxReference.allocationSize(value.`boxRef`)
    )
  ...
  override fun write(
    ...
    FfiConverterOptionalULong.write(value.`asset`, buf)
    FfiConverterOptionalULong.write(value.`app`, buf)
    FfiConverterOptionalTypeHoldingRef.write(value.`holding`, buf)
    FfiConverterOptionalTypeLocalsRef.write(value.`locals`, buf)
    FfiConverterOptionalTypeBoxReference.write(value.`boxRef`, buf)
  }
}
...
data class SignedTransaction(
   ...
   */
  var `logicSignature`: LogicSignature? = null,
) {
  companion object
}
...
public object FfiConverterTypeSignedTransaction : FfiConverterRustBuffer<SignedTransaction> {
  override fun read(buf: ByteBuffer): SignedTransaction =
    SignedTransaction(
      ...
      FfiConverterOptionalString.read(buf),
      FfiConverterOptionalTypeMultisigSignature.read(buf),
      FfiConverterOptionalTypeLogicSignature.read(buf),
    )
  ...
  override fun allocationSize(value: SignedTransaction) =
    (
      FfiConverterTypeTransaction.allocationSize(value.`transaction`) +
        ...
        FfiConverterOptionalTypeMultisigSignature.allocationSize(value.`multisignature`) +
        FfiConverterOptionalTypeLogicSignature.allocationSize(value.`logicSignature`)
    )
  ...
  override fun write(
    ...
    FfiConverterOptionalTypeMultisigSignature.write(value.`multisignature`, buf)
    FfiConverterOptionalTypeLogicSignature.write(value.`logicSignature`, buf)
  }
}
...
public object FfiConverterTypeStateProofTransactionFields : FfiConverterRustBuffer<StateProofTransactionFields> {
  ...
  override fun write(
    value: StateProofTransactionFields,
    buf: ByteBuffer,
  ) {
...
public object FfiConverterTypeAlgoKitTransactError : FfiConverterRustBuffer<AlgoKitTransactException> {
  override fun read(buf: ByteBuffer): AlgoKitTransactException =
    when (buf.getInt()) {
      ...
      5 -> {
        AlgoKitTransactException.SigningException(
          FfiConverterString.read(buf),
        )
      }
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeBoxReference : FfiConverterRustBuffer<BoxReference?> {
  override fun read(buf: ByteBuffer): BoxReference? {
    if (buf.get().toInt() == 0) {
      return null
    }
    return FfiConverterTypeBoxReference.read(buf)
  }

  override fun allocationSize(value: BoxReference?): ULong {
    if (value == null) {
      return 1UL
    } else {
      return 1UL + FfiConverterTypeBoxReference.allocationSize(value)
    }
  }
  ...
  override fun write(
    ...
    if (value == null) {
      ...
      buf.put(1)
      FfiConverterTypeBoxReference.write(value, buf)
    }
  }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeHoldingRef : FfiConverterRustBuffer<HoldingRef?> {
  override fun read(buf: ByteBuffer): HoldingRef? {
    if (buf.get().toInt() == 0) {
      return null
    }
    return FfiConverterTypeHoldingRef.read(buf)
  }

  override fun allocationSize(value: HoldingRef?): ULong {
    if (value == null) {
      return 1UL
    } else {
      return 1UL + FfiConverterTypeHoldingRef.allocationSize(value)
    }
  }
  ...
  override fun write(
    ...
    if (value == null) {
      ...
      buf.put(1)
      FfiConverterTypeHoldingRef.write(value, buf)
    }
  }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeLocalsRef : FfiConverterRustBuffer<LocalsRef?> {
  override fun read(buf: ByteBuffer): LocalsRef? {
    if (buf.get().toInt() == 0) {
      return null
    }
    return FfiConverterTypeLocalsRef.read(buf)
  }

  override fun allocationSize(value: LocalsRef?): ULong {
    if (value == null) {
      return 1UL
    } else {
      return 1UL + FfiConverterTypeLocalsRef.allocationSize(value)
    }
  }
  ...
  override fun write(
    ...
    if (value == null) {
      ...
      buf.put(1)
      FfiConverterTypeLocalsRef.write(value, buf)
    }
  }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeLogicSignature : FfiConverterRustBuffer<LogicSignature?> {
  override fun read(buf: ByteBuffer): LogicSignature? {
    if (buf.get().toInt() == 0) {
      return null
    }
    return FfiConverterTypeLogicSignature.read(buf)
  }

  override fun allocationSize(value: LogicSignature?): ULong {
    if (value == null) {
      return 1UL
    } else {
      return 1UL + FfiConverterTypeLogicSignature.allocationSize(value)
    }
  }
  ...
  override fun write(
    ...
    if (value == null) {
      ...
      buf.put(1)
      FfiConverterTypeLogicSignature.write(value, buf)
    }
  }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalSequenceTypeResourceRef : FfiConverterRustBuffer<List<ResourceRef>?> {
  override fun read(buf: ByteBuffer): List<ResourceRef>? {
    if (buf.get().toInt() == 0) {
      return null
    }
    return FfiConverterSequenceTypeResourceRef.read(buf)
  }

  override fun allocationSize(value: List<ResourceRef>?): ULong {
    if (value == null) {
      return 1UL
    } else {
      return 1UL + FfiConverterSequenceTypeResourceRef.allocationSize(value)
    }
  }
  ...
  override fun write(
    ...
    if (value == null) {
      ...
      buf.put(1)
      FfiConverterSequenceTypeResourceRef.write(value, buf)
    }
  }
}
 ...
 * @suppress
 */
public object FfiConverterSequenceTypeResourceRef : FfiConverterRustBuffer<List<ResourceRef>> {
  override fun read(buf: ByteBuffer): List<ResourceRef> {
    val len = buf.getInt()
    return List<ResourceRef>(len) {
      FfiConverterTypeResourceRef.read(buf)
    }
  }

  override fun allocationSize(value: List<ResourceRef>): ULong {
    val sizeForLength = 4UL
    val sizeForItems = value.map { FfiConverterTypeResourceRef.allocationSize(it) }.sum()
    return sizeForLength + sizeForItems
  }
  ...
  override fun write(
    ...
    buf.putInt(value.size)
    value.iterator().forEach {
      FfiConverterTypeResourceRef.write(it, buf)
    }
  }
}
  ...
  FfiConverterTypeSignedTransaction.lift(
    uniffiRustCallWithError(AlgoKitTransactException) { _status ->
      UniffiLib.INSTANCE.uniffi_algokit_transact_ffi_fn_func_ed25519_sign_transaction(
        ...
        FfiConverterTypeTransaction.lower(`txn`),
        _status,
      )
    },
  )
 ...
 */
@Throws(AlgoKitTransactException::class)
fun `getLogicSignatureAddress`(`logic`: kotlin.ByteArray): kotlin.String =
  FfiConverterString.lift(
    uniffiRustCallWithError(AlgoKitTransactException) { _status ->
      UniffiLib.INSTANCE.uniffi_algokit_transact_ffi_fn_func_get_logic_signature_address(FfiConverterByteArray.lower(`logic`), _status)
    },
  )
 ...
 */
@Throws(AlgoKitTransactException::class)
fun `getLogicSignatureBytesToSign`(`logic`: kotlin.ByteArray): kotlin.ByteArray =
  FfiConverterByteArray.lift(
    uniffiRustCallWithError(AlgoKitTransactException) { _status ->
      UniffiLib.INSTANCE.uniffi_algokit_transact_ffi_fn_func_get_logic_signature_bytes_to_sign(
        FfiConverterByteArray.lower(`logic`),
        _status,
      )
    },
  )
 ...
 */
@Throws(AlgoKitTransactException::class)
fun `getLogicSignatureBytesToSignForMultisig`(
  `logic`: kotlin.ByteArray,
  `multisignature`: MultisigSignature,
): kotlin.ByteArray =
  FfiConverterByteArray.lift(
    uniffiRustCallWithError(AlgoKitTransactException) { _status ->
      UniffiLib.INSTANCE.uniffi_algokit_transact_ffi_fn_func_get_logic_signature_bytes_to_sign_for_multisig(
        FfiConverterByteArray.lower(`logic`),
        FfiConverterTypeMultisigSignature.lower(`multisignature`),
        _status,
      )
    },
  )
 ...
 */
@Throws(AlgoKitTransactException::class)
fun `validateLogicSignature`(`logicSignature`: LogicSignature) =
  uniffiRustCallWithError(AlgoKitTransactException) { _status ->
    UniffiLib.INSTANCE.uniffi_algokit_transact_ffi_fn_func_validate_logic_signature(
      FfiConverterTypeLogicSignature.lower(`logicSignature`),
      _status,
    )
  }
