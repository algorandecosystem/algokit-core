 ...
 * `packages/android/algokit_transact`. It publishes a plain JAR that can be used
...
mavenPublishing {
  ...
  coordinates(
    ...
    "algokit-transact-jvm",
    System.getenv("VERSION_TAG") ?: "0.0.1-SNAPSHOT"
  )

  pom {
    name.set("AlgoKit Transact (JVM)")
    description.set("Algorand transaction operations for the desktop JVM")
