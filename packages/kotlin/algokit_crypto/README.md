...
A Kotlin/JVM ("desktop") build of `algokit_crypto`, for use in any JVM application
(desktop apps, servers, CLIs, etc.) rather than Android. It's built from the exact
same Rust core and uniffi-generated Kotlin bindings as `packages/android/algokit_crypto`
...
`win32-x86-64`), and produces a JAR at `build/libs/algokit_crypto-*.jar`.
