 ...
 * `packages/android/algokit_crypto`. It publishes a plain JAR that can be used
...
mavenPublishing {
  ...
  pom {
    name.set("AlgoKit Crypto (JVM)")
    description.set("Algorand cryptographic operations for the desktop JVM")
